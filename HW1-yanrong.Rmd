...
output: 
  html_document: 
    ...
    toc_float:
      ...
      smooth_scroll: false
params:
  name: ["林奕翔","張鈞硯","賴彥融","吳宥履","王童緯"]
  id: [710761132,710761104,710761101,710761118,710761115]
  group: "team b"
  url: ""
---
...
令$\delta_{k}=PR_{1k}-PR_{0k}$代表每個人有沒有被擋修的成績效果，
假設每個人沒有被擋修的效果相同$\delta_{k}=\delta$,則：
...
<table><tr><td bgcolor=#F5F5DC>
$$\hat{\beta}_1=\frac{\sum_{i=1}^N (x_i-\bar{x})(y_i-\bar{y})}{\sum_{i=1}^N (x_i-\bar{x})^2}=\frac{\sum_{i,x_i=1}^N (1-\frac{n_1}{n})(y_i-\bar{y})+\sum_{i,x_i=0}^N (0-\frac{n_1}{n})(y_i-\bar{y})}{\sum_{i,x_i=1}^N (1-\frac{n_1}{n})^2+\sum_{i,x_i=0}^N (0-\frac{n_1}{n})^2}$$
&nbsp;
...
&nbsp;
$$=\frac{(\frac{\sum_{i,x_i=1}^N y_i}{n_1})+(\frac{\sum_{i,x_i=0}^N y_i}{n_0})}{\frac{n_0+ n_1}{n}}=\bar{y_1}+\bar{y_2}$$
</td></tr></table>
